// File: D:\pro\repo-atlas\apps\docs\src\app\playground\page.tsx
...
type TEntry = typeof import('../../../../src/app/playground/page.js');
...
if ('generateMetadata' in entry) {
  checkFields<
    Diff<PageProps, FirstArg<MaybeField<TEntry, 'generateMetadata'>>, 'generateMetadata'>
  >();
  checkFields<
...
if ('generateViewport' in entry) {
  checkFields<
    Diff<PageProps, FirstArg<MaybeField<TEntry, 'generateViewport'>>, 'generateViewport'>
  >();
  checkFields<
