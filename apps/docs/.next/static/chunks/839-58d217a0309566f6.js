  ...
  [839],
  {
    ...
    5411: function (e, t, n) {
      ...
      function E(e, t, n, r, o, a) {
        if ('undefined' != typeof window && (a || (0, u.isLocalURL)(t))) {
      ...
      let y = a.default.forwardRef(function (e, t) {
        ...
        let j = a.default.useContext(f.RouterContext),
          w = a.default.useContext(d.AppRouterContext),
          M = null != j ? j : w,
          L = !j,
          D = !1 !== P,
          k = null === P ? g.PrefetchKind.AUTO : g.PrefetchKind.FULL,
          { href: U, as: F } = a.default.useMemo(() => {
            if (!j) {
              let e = R(l);
              return { href: e, as: m ? R(m) : e };
            }
            let [e, t] = (0, i.resolveHref)(j, l, !0);
            return { href: e, as: m ? (0, i.resolveHref)(j, m) : t || e };
          }, [j, l, m]),
          X = a.default.useRef(U),
          W = a.default.useRef(F);
        C && (r = a.default.Children.only(n));
        let G = C ? r && 'object' == typeof r && r.ref : t,
          [H, Y, B] = (0, p.useIntersection)({ rootMargin: '200px' }),
          K = a.default.useCallback(
            (e) => {
              ((W.current !== F || X.current !== U) && (B(), (W.current = F), (X.current = U)),
                H(e),
        ...
        a.default.useEffect(() => {
          M && Y && D && E(M, U, F, { locale: v }, { kind: k }, L);
        }, [F, U, Y, v, D, null == j ? void 0 : j.locale, M, L, k]);
        let V = {
          ref: K,
          onClick(e) {
              ...
              M &&
                ...
                (function (e, t, n, r, o, i, l, s, c) {
                  ...
                  let d = () => {
                    let e = null == l || l;
                    'beforePopState' in t
                      ? t[o ? 'replace' : 'push'](n, r, { shallow: i, locale: s, scroll: e })
          ...
          onMouseEnter(e) {
            (C || 'function' != typeof T || T(e),
              ...
              M &&
                (D || !L) &&
                E(M, U, F, { locale: v, priority: !0, bypassPrefetchedCheck: !0 }, { kind: k }, L));
          },
        ...
        if ((0, s.isAbsoluteUrl)(F)) V.href = F;
        else if (!C || S || ('a' === r.type && !('href' in r.props))) {
          let e = void 0 !== v ? v : null == j ? void 0 : j.locale,
            t =
          ...
          V.href =
            t || (0, _.addBasePath)((0, c.addLocale)(F, e, null == j ? void 0 : j.defaultLocale));
        }
        return C ? a.default.cloneElement(r, V) : (0, o.jsx)('a', { ...x, ...V, children: n });
      });
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
    ...
    9272: function (e, t, n) {
      ...
      let r = n(6150)._(n(4254)).default.createContext(null);
    },
    3237: function (e, t, n) {
      (Object.defineProperty(t, '__esModule', { value: !0 }),
        (function (e, t) {
      ...
      function a(e) {
        ...
        ((t = t ? encodeURIComponent(t).replace(/%3A/i, ':') + '@' : ''),
          e.host
            ? (s = t + e.host)
            : n && ((s = t + (~n.indexOf(':') ? '[' + n + ']' : n)), e.port && (s += ':' + e.port)),
          ...
          return (
            Object.keys(n).forEach((e) => {
              let t = n[e],
                r = o[t.pos];
              void 0 !== r &&
                (i[e] = ~r.indexOf('/') ? r.split('/').map((e) => a(e)) : t.repeat ? [a(r)] : a(r));
            }),
            i
          );
        };
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = o.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                i = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && i) {
                let { key: e, optional: o, repeat: l } = u(i[1]);
                return (
                  (n[e] = { pos: r++, repeat: l, optional: o }),
